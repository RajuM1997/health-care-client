...
import { doctorAppointmentColumns } from "./DoctorAppointmentTable";
import DoctorAppointmentDetailDialog from "./doctorAPpointmentColumns";
import ChangeAppointmentStatusDialog from "./ChangeAppointmentStatusDailog";
